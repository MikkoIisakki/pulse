...
description: Static analysis, linting, formatting, type checking, security scanning, and complexity tools used in the recommendator project. All gates enforced in CI. For engineer and devops use.
---

...
description: Academic and practitioner evidence behind each factor used in the recommendator scoring model. Provides the research basis for factor adoption, weighting, and retirement decisions.
---
